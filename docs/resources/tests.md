...
- `kubernetes_version` (String) The Kubernetes minor version of the EKS control plane, e.g. '1.32' (default is the eksctl default version). Nodegroups follow the control plane version.
